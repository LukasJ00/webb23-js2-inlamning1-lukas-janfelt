...
})({"a5aJT":[function(require,module,exports) {
...
function determineWinner(playerChoice, computerChoice) {
    if (playerChoice === "sten" && computerChoice === "sax" || playerChoice === "sax" && computerChoice === "p\xe5se" || playerChoice === "p\xe5se" && computerChoice === "sten") return "player";
    else if (playerChoice === "sax" && computerChoice === "sten" || playerChoice === "p\xe5se" && computerChoice === "sax" || playerChoice === "sten" && computerChoice === "p\xe5se") return "computer";
    else return "tie";
}
...
async function postHighscore(playerName, playerScore) {
    ...
    if (response.status === 200) console.log("Highscore uppdaterad");
    else console.error("N\xe5got gick fel n\xe4r highscore skulle uppdateras");
}
...
},{}]},["a5aJT","cxmN0"], "cxmN0", "parcelRequire5b12")
